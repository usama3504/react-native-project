...
const GameStart=()=>{
    ...
    const [modalIsVisibal,setModalIsVisibal]=useState<boolean>(false);
    ...
    const enteredTexthandler=(enteredText:string)=>{
        ...
        checkEnteredNumberIsValid(Number(enteredText))
    }

    const checkEnteredNumberIsValid=(number:number)=>{
        if(number<1)
        {
            Alert.alert(
                "Invalid Number!",
        ...
        <View style={styles.container}>
            ...
            <View style={styles.numberContainer}>
                ...
                <View style={styles.guessNumberText}>
                    <TextInput     value={enteredNumber?.toString()} keyboardType='numeric' style={styles.guessNumberText}  placeholder="Enter Number" onChangeText={enteredTexthandler} ></TextInput>
                </View>
